...
const Home = () => {
  const menus = [
    { to: "/hp", label: "Harry Potter", icon: "⚡", color: "hover:border-purple-500" },
    { to: "/chuck", label: "Chuck Jokes", icon: "🤠", color: "hover:border-orange-500" },
    { to: "/avocado", label: "Avocado Store", icon: "🥑", color: "hover:border-green-500" },
    { to: "/database", label: "Firebase DB", icon: "⚽", color: "hover:border-blue-500" },
  ];
