    ...
    <>
      ...
      <div className="max-w-6xl mx-auto mt-10 p-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link to="/payfb/create" className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-xl font-semibold transition-all shadow-lg shadow-indigo-100 flex items-center gap-2">
